...
pension_agent = get_pension(debug_mode=True)
...
playground = Playground(agents=[sage_agent, scholar_agent, pension_agent], teams=[finance_researcher_team, multi_language_team])
